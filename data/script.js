...
function onMessage(event) {
  ...
  // --- Gestion des messages WebSocket spécifiques ---
  ...
  switch (data.cibleHoraire) {
    case 0: document.getElementById('imageHoraire').src = 'cible_0.jpg'; break;
    case 1: document.getElementById('imageHoraire').src = 'cible_1.jpg'; break;
    case 2: document.getElementById('imageHoraire').src = 'cible_2.jpg'; break;
    case 3: document.getElementById('imageHoraire').src = 'cible_3.jpg'; break;
  }

  switch (data.cibleAntiHor) {
    case 0: document.getElementById('imageAntiHor').src = 'cible_0.jpg'; break;
    case 1: document.getElementById('imageAntiHor').src = 'cible_1.jpg'; break;
    case 2: document.getElementById('imageAntiHor').src = 'cible_2.jpg'; break;
    case 3: document.getElementById('imageAntiHor').src = 'cible_3.jpg'; break;
  }

  document.getElementById('discovery_on').checked = data.discovery_on;
  document.getElementById('wifi_on').checked = data.wifi_on;

  // --- Mise à jour du type de canton (si présent dans le JSON complet) ---
...
function typeCantonChange(obj) {
  const msg = {
    cmd: "setRole",
    value: parseInt(obj.value)   // 0..6
  };
  websocket.send(JSON.stringify(msg));
}

// -----------------------------
// Fonctions diverses existantes
// -----------------------------
