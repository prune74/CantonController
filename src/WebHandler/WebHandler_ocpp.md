                         ...
                         AwsEventType type, void *arg, uint8_t *data, size_t len)
{
  ...
  case WS_EVT_CONNECT:
    ...
    SA_LOG("WebSocket client #%u connected from %s\n",
  ...
  case WS_EVT_DISCONNECT:
    ...
    SA_LOG("WebSocket client #%u disconnected\n", client->id());
  ...
  case WS_EVT_DATA:
    ...
    SA_LOG("[WebHandler %d] : WebSocket len %d\n", __LINE__, len);
